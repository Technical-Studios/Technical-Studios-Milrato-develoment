    ...
    try {
      ...
      async function menuselection(menu) {
        ...
        await menu?.reply({embeds : [new MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.la[ls].cmds.info.botfaq.menuembed.title, client.user.displayAvatarURL(), "https://team.aracdes.ga/discord")
          ...
          message.reply({embeds : [new MessageEmbed()
            .setAuthor(`New Invites of: ${user.tag}`, user.displayAvatarURL({dynamic: true}), "https://team.aracdes.ga/discord")
